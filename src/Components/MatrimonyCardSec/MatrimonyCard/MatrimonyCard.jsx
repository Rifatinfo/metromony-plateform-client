const MatrimonyCard = () => {
  return (
    <div className="flex items-center max-w-md  rounded-md shadow-xl  overflow-hidden border-transparent   hover:shadow-lg hover:scale-105 transition-all duration-300">
      {/* Profile Image */}
      <img
